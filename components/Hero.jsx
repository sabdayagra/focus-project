...
const Hero = () => {
  ...
  return (
    <section className="h-screen xl:h-[1600px] overflow-x-clip realtive">
      <Header />
      <div className="container mx-auto h-full flex items-center xl:items-start">
        {/* text */}
        <motion.div
          className="flex flex-col justify-center items-center gap-6 text-center fixed right-0 left-0 mt-24 xl:mt-[160px]"
          style={{
            opacity: textOpacity,
            scale: textScale,
            display: textDisplay,
        ...
        >
          ...
          <p className="max-w-[680px] text-[20px] text-white/80 fonti-light px-8 xl:px-0 mb-2">Streamline tasks and manage your time effortlessly wirh our powerfull, intuitive, all in one productivity platform.</p>
